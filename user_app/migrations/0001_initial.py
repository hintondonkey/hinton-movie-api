    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.CharField(default='', max_length=250, null=True)),
                ...
                ('account_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='user_app.accounttype')),
