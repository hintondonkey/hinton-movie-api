...
urlpatterns = [
    ...
    path("get_sub_category_broker_service/<int:category_id>/<int:broker_id>/", views.SubCategoryCategoryBrokerListAPIView.as_view(), name="get_sub_category_category_broker_service"),
